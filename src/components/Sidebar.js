...
export default function Sidebar() {
  ...
  return (
    <div className="w-60 flex-none h-full overflow-y-auto flex flex-col items-start p-2 border-r border-gray-200">
      ...
      <DraggableDiv
        type={Constants.SAY_HELLO_FOR_TWO_SECONDS}
        onClick={onSayHelloClicked}
      >
        <div className="flex flex-row flex-wrap bg-purple-500 text-white px-2 py-1 my-2 text-sm cursor-pointer">
      ...
      <DraggableDiv
        type={Constants.THINK_HMM}
        onClick={onThinkHmmClicked}
      >
        <div className="flex flex-row flex-wrap bg-purple-500 text-white px-2 py-1 my-2 text-sm cursor-pointer">
          {"Think hmm"}
        </div>
      ...
      <DraggableDiv
        type={Constants.THINK_HMM_FOR_TWO_SECONDS}
        onClick={onThinkHmmClicked}
      >
        <div className="flex flex-row flex-wrap bg-purple-500 text-white px-2 py-1 my-2 text-sm cursor-pointer">
